            ...
            >
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text trxt-base font-medium">Product Name</span>
                </label>
                <input
                  type="text"
              ...
              <div className="flex justify-between mt-8">
                <button type="button" onClick={handleDelete} className="btn btn-error rounded-box">
